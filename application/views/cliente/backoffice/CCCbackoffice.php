<div id="content" class="ui-content ui-content-aside-overlay">
    <div class="ui-content-body">
        ...
        <div class="ui-container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p>Olá <?php echo InformacoesUsuario('nome');?>, bem-vindo. Desfrute do que de melhor temos a lhe oferecer Duvidas chame Suporte 85 991302069.</p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="panel short-states bg-danger">
                        ...
                        <div class="panel-body">
                            ...
                            <strong class="text-uppercase">Lucros</strong>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="panel short-states bg-info">
                        ...
                        <div class="panel-body">
                            ...
                            <strong class="text-uppercase">Bonus de Indicacao</strong>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="panel short-states bg-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <strong class="text-uppercase">Carreira</strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="panel short-states bg-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <strong class="text-uppercase">Binário</strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="panel short-states bg-primary" style="background:#2E3E4E;">
                        ...
                        <div class="panel-body">
                            ...
                            <strong class="text-uppercase">Valor pagos no Sistema</strong>
                        </div>
                    </div>
                </div>
                <?php
