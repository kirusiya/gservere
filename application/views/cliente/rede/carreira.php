...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
   ...
   <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2" id="kt_toolbar">
      ...
      <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
         <!--begin::Title-->
         <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Section: Career Plans</h1>
         <!--end::Title-->
         <!--begin::Breadcrumb-->
         <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-muted">Career Plans</li>
            <!--end::Item-->
         ...
         <div class="card card-flush h-xl-100">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
               ...
               <h3 class="card-title align-items-start flex-column">
                  <span class="card-label fw-bold text-gray-900"><?php echo lang('career_plans')?></span>
               </h3>
               <!--end::Card title-->
               <!--begin::Card title-->
