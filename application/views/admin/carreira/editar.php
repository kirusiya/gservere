...
<div id="content" class="ui-content">
    <div class="ui-content-body">
        <div class="ui-container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <h1 class="page-title"> Editar Plan de Carrera
                        <small>editar un plan de carrera</small>
                    </h1>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb pull-right">
                        <li>Inicio</li>
                        <li>Planes</li>
                        <li><a href="<?php echo base_url('admin/carreira/editar/'.$this->uri->segment(4));?>" class="active">Editar Plan de Carrera</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <section class="panel">
                        ...
                        <form action="" method="post" class="form-horizontal form-variance">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                    <input type="submit" name="submit" class="btn btn-success" value="Editar Plan de Carrera">
                              </div>
                          </div>
